...
public:
     ...
     * @return 套接字
     */
    static Socket::Ptr CreateTCP(Address::Ptr address = nullptr);
     ...
     * @return 套接字
     */
    static Socket::Ptr CreateUDP(Address::Ptr address = nullptr);
     ...
     * @return 套接字
     */
    static Socket::Ptr CreateTCP6(Address::Ptr address = nullptr);
     ...
     * @return 套接字
     */
    static Socket::Ptr CreateUDP6(Address::Ptr address = nullptr);
     ...
     * @return 是否成功
     */
    bool Connect(const Address::Ptr dest, int64_t time_out_ms = -1);
     ...
     * @return 发送成功的字节数
     */
    int SendTo(const Address::Ptr to, const char* buffer, size_t len, int flags = 0);
     ...
     * @return 发送成功的字节数
     */
    int SendTo(const Address::Ptr to, const std::string& buffer, int flags = 0);
     ...
     * @return 发送成功的字节数
     */
    int SendTo(const Address::Ptr to, const iovec* iov, size_t iov_len, int flags = 0);
     ...
     * @return 发送成功的字节数
     */
    int RecvFrom(Address::Ptr from, const char* buffer, size_t len, int flags = 0);
     ...
     * @return 发送成功的字节数
     */
    int RecvFrom(Address::Ptr from, std::string& buffer, int flags = 0);
     ...
     * @return 发送成功的字节数
     */
    int RecvFrom(Address::Ptr from, iovec* iov, size_t iov_len, int flags = 0);
...
private:
    ...
    Address::Ptr local_address  = nullptr;
    Address::Ptr remote_address = nullptr;
};
